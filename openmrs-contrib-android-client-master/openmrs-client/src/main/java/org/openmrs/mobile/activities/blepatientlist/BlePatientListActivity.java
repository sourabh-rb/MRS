...
public class BlePatientListActivity extends ACBaseActivity {

    private BlePatientListContract.Presenter mPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create fragment
        BlePatientListFragment formEntryPatientListFragment =
                (BlePatientListFragment) getSupportFragmentManager().findFragmentById(R.id.formEntryPatientListContentFrame);
        if (formEntryPatientListFragment == null) {
            formEntryPatientListFragment = BlePatientListFragment.newInstance();
        }
        ...
        mPresenter = new BlePatientListPresenter(formEntryPatientListFragment);
    }
