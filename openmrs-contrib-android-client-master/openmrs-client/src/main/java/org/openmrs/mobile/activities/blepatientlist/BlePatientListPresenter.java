...
public class BlePatientListPresenter extends BasePresenter implements BlePatientListContract.Presenter {

    private final BlePatientListContract.View mFormEntryPatientListView;
    private PatientDAO patientDAO;
    private String mQuery;

    public BlePatientListPresenter(BlePatientListContract.View view) {
        this.mFormEntryPatientListView = view;
        this.mFormEntryPatientListView.setPresenter(this);
        this.patientDAO = new PatientDAO();
    }

    public BlePatientListPresenter(BlePatientListContract.View view, PatientDAO patientDAO) {
        this.mFormEntryPatientListView = view;
        this.mFormEntryPatientListView.setPresenter(this);
