...
import org.openmrs.mobile.activities.deviceble.PlotEcgActivity;
...
public class BlePatientListFragment extends ACBaseFragment<BlePatientListContract.Presenter> implements  BlePatientListContract.View {
    ...
    public void updateAdapter(List<Patient> patientList) {
        BlePatientListAdapter adapter = new BlePatientListAdapter(this,patientList);
    ...
    @Override
    public void startEncounterForPatient(String selectedPatientID) {
        Intent intent = new Intent(this.getActivity(), PlotEcgActivity.class);
        intent.putExtra(ApplicationConstants.BundleKeys.PATIENT_ID_BUNDLE, selectedPatientID);
        startActivity(intent);
    }

    public static BlePatientListFragment newInstance() {
        return new BlePatientListFragment();
    }
