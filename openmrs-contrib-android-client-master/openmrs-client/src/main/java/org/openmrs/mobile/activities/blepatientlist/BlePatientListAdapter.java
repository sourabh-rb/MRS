...
public class BlePatientListAdapter extends RecyclerView.Adapter<BlePatientListAdapter.PatientViewHolder> {
    private BlePatientListFragment mContext;
    private List<Patient> mItems;

    public BlePatientListAdapter(BlePatientListFragment context, List<Patient> items) {
    ...
    public void onBindViewHolder(PatientViewHolder holder, final int position) {
        ...
        holder.mRowLayout.setOnClickListener(v ->
                mContext.startEncounterForPatient(mItems.get(adapterPos).getUuid()));
