...
public class AttachmentsContext extends ModuleProperties {
	...
	public static ContentFamily getContentFamily(String mimeType) {
		...
		if (StringUtils.startsWith(mimeType, "application/vnd.ms-excel") | StringUtils.startsWith(mimeType, "text/csv")) {
			contentFamily = ContentFamily.CSV;
		}
